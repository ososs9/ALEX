...
SUDO = SUDO
sudo_users = {SUDO,1878146526,1929030906,1691710259}   
print([[
┏┓━━━━━━━━━━━┏┓━━━━━━━━
┃┃━━━━━━━━━━━┃┃━━━━━━━━
┃┗━┓┏━━┓┏┓━┏┓┃┃┏┓┏━━┓         
...
━━━━━━━━┗━━┛━━━━━━━━━━━
> CH › @omarvvi
~> DEVELOPER › @OSDDR , @Ommmarrrrrrr , @Elkomanda_y3m
]])
if io.open("library/redis.lua","r") then
io.close(io.open("library/redis.lua","r"))
print("done => redis.lua")
else
io.popen("cd library && wget https://raw.githubusercontent.com/ososs9/ALEX/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ososs9/ALEX/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevBoykAW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBoykAW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevBoykAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevBoykAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevBoykAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1878146526) then  
var = true  
elseif tonumber(user_id) == tonumber(1929030906) then
var = true  
tonumber(1691710259) then  
var = true  
...
elseif tonumber(user_id) == tonumber(1929030906) then
var = 'مبرمج السورس'
elseif tonumber(user_id) == tonumber(1691710259) then
var = 'عنتيل اليكس'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@DEVELOPER_ALEX")  
...
--------------------------------------------------------------------------------------------------------------
function SourceBoykA(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."BoykA1:List:Filter"..sl)
...
os.execute('wget https://raw.githubusercontent.com/ososs9/ALEX/main/BoykA.lua')
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✬︙[تحديثات البوت](t.me/omarvvi) \n✬︙[قناه السورس](t.me/omarvvi)')
end
...
usertext = '*\n ✬︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'omarvvi')..')'
status  = '\n *✬︙تم ترقيته مطور*'
...
usertext = '\n *✬︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'omarvvi')..')'
status  = '\n*✬︙تم ترقيته مطور*'
...
if BoykA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✬︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'omarvvi')..') \n ✬︙'..BoykA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
send(msg.chat_id_,0," *✬︙العضو :* {["..data.first_name_.."](t.me/omarvvi)}\n✬︙["..BoykA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,msg.id_,'✫: شترك في قناة السورس اولآ @omarvvi .')   
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ＳＯＵＲＣＥ ＡＬＥＸ\n\n[-  ＡＬＥＸ ᴄʜᴀɴɴᴇʟ  .](http://t.me/omarvvi)\n\n[-  ɪɴғᴏ sᴏᴜʀᴄᴇ .](http://t.me/omarvvi)\n\n[-  ＡＬＥＸ ᴅᴇᴠᴇʟᴏᴘᴇʀ  .](http://t.me/DEVELOPER_ALEX)\n\n[-  ʙᴏᴛ ＡＬＥＸ .](http://t.me/UU_ALEXXX_BOT)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✫: ＡＬＥＸ sᴏᴜʀᴄe .',url="t.me/omarvvi"}},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_, '*✬︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'omarvvi')..') \n*✬︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✬︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'omarvvi')..') \n*✬︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
function start_function(extra, result, success)
if BoykASudoBot(result.sender_user_id_) then
...
if BoykASudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if DevBoykAW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ososs9/ALEX/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/ososs9/ALEX/main/File_Bot/"..file)
if res == 200 then
...
local UserName = (b.username_ or "omarvvi")
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'omarvvi')..')'
status  = '\n*✬︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✬︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'omarvvi')..')'
status  = '\n*✬︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *✬︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'omarvvi')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *✬︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'omarvvi')..')'..'\n*✬︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,BoykA)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ ＡＬＥＸ ━━━━━━━•*\n"
x = 0
...
if BoykASudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'omarvvi')..')'
local iduser = result.sender_user_id_
...
if text == 'استعاده الاوامر' and DevBoykAW(msg) then
...
if text == 'تغير امر م3' and DevBoykAW(msg) then
...
{{text = '- ＳＯＵＲＣＥ ＡＬＥＸ', url="t.me/omarvvi"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = '- ＳＯＵＲＣＥ ＡＬＥＸ', url="t.me/omarvvi"}},
{{text = 'مطور السورس', url="t.me/DEVELOPER_ALEX"}},
}
...
send(msg.chat_id_, msg.id_, t..'ٴ✬∫ٴ*•━━━━━━ ＡＬＥＸ ━━━━━━━•*ٴ✬∫○ٴ\n✬︙[- ＳＯＵＲＣＥ ＡＬＥＸ](t.me/omarvvi) ')
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- sᴏᴜʀᴄe ＡＬＥＸ.',url="t.me/omarvvi"}},
}
local msg_id = msg.id_/2097152/0.5
...
{{text = '~ BoYKA •',url='http://t.me/omarvvi'}},
}
...
inline = {
{{text = 'ＳＯＵＲＣＥ ＡＬＥＸ',url='http://t.me/omarvvi'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
