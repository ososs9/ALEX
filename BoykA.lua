...
SUDO = SUDO
sudo_users = {SUDO,1878146526,1929030906,1691710259,1661260546}   
print([[
┏┓━━━━━━━━━━━┏┓━━━━━━━━
┃┃━━━━━━━━━━━┃┃━━━━━━━━
┃┗━┓┏━━┓┏┓━┏┓┃┃┏┓┏━━┓         
...
━━━━━━━━┗━━┛━━━━━━━━━━━
> CH › @omarvvi
~> DEVELOPER › @OSDDR @Elkomanda_y3m @Ommmarrrrrrr
]])
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/BOBBW/Files_BoykA/main/File_Bot/commands.lua") 
...
var =  true
elseif tonumber(user_id) == tonumber(1661260546) then
var =  true
...
{{text = '- ＳＯＵＲＣＥ ＡＬＥＸ', url="t.me/BOBBW"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = '~ BoYKA •',url='https://t.me/omarvvi'}},
}
...
inline = {
{{text = 'ＳＯＵＲＣＥ ＡＬＥＸ',url='https://t.me/omarvvi'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
